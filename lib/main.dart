...
import 'package:metrocane/network/network_manager.dart';
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) async {
      if (mounted) { 
        ...
        if (file != null) {
          String base64 = await xFileToBase64(file);
          _manager.processImageRequest(base64);
        }
      }
    });
  }
